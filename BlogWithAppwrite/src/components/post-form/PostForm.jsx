...
export default function PostForm({ post }) {
    ...
    const submit = async (data) => {
        ...
        if (post) {
            ...
            const dbPost = await appwriteService.updatePost(
                post.$id,
                {
                    ...
                    // New image → use new file ID
                    // No new image → keep old file ID
                    featuredImage: file
                        ? file.$id
                        : post.featuredImage,
                }
        ...
        // =========================
            ...
            if (file) {
                // Get Appwrite Storage file ID
                const fileId = file.$id;

                // Store file ID in featuredImage
    ...
    return (
        ...
        >
            ...
            <div className="w-1/3 px-2">
                ...
                {/* Show existing image only if
                    featuredImage actually exists */}
                {post?.featuredImage && (
